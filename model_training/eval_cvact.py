...
'''
This file is used to evaluate the VIGOR model on the CVACT dataset.
...
class Configuration:
    ...
    checkpoint_start = 'cvact/convnext_base.fb_in22k_ft_in1k_384/05062224/weights_e60_89.9820.pth'  # Path to pretrained weights
...
if __name__ == '__main__':
    ...
    # Save visualization results for validation set
    save_top_matches_cvact(
        ...
        num_queries=80,
        top_n=5,
        output_dir="cvact_top_matches_val",
